...
- mpg123-decoder
- Listen1 / listen1_desktop compatibility references (MIT License)
...
Listen1 兼容功能用于读取用户自有 Listen1 备份中的歌单元数据，并在播放时实时尝试当前公开可访问或用户已授权的音源版本；不会使用或分发 Listen1 旧播放直链，也不用于绕过任何平台的会员、付费、版权、地区或登录限制。
